...
<!-- Generated from plugins/core/commands/deepen-plan.md -->
...
- Launch ALL agents in a SINGLE message with multiple agent spawning calls
...
After writing the enhanced plan, use the **ask the user directly tool** to present these options:

**Question:** "Plan deepened at `[plan_path]`. What would you like to do next?"

**Options:**
1. **View diff** - Show what was added/changed
2. **Run `/prompts:plan_review`** - Get feedback from reviewers on enhanced plan
...
**After (from /prompts:deepen-plan):**
```markdown
## Technical Approach
