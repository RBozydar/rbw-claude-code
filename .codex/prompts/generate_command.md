...
<!-- Generated from plugins/core/commands/generate_command.md -->
<!-- Do not edit by hand. Regenerate from the Claude command source. -->

# Create a Custom Claude Code Command

Create a new slash command in `.codex/commands/` for the requested task.
...
1. **Create the file** at `.codex/commands/[name].md` (subdirectories like `workflows/` supported)
