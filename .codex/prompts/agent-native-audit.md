...
<!-- Generated from plugins/core/commands/agent-native-audit.md -->
...
Launch 8 parallel sub-agents using the agent spawning with `subagent_type: Explore`, one for each principle. Each agent should:
