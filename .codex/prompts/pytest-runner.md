...
<!-- Generated from plugins/python-backend/commands/pytest-runner.md -->
...
```bash
/prompts:pytest-runner                    # Run all tests
/prompts:pytest-runner tests/unit/        # Run specific directory
/prompts:pytest-runner -k "test_user"     # Run tests matching pattern
/prompts:pytest-runner affected           # Run tests for changed files only
/prompts:pytest-runner --coverage         # Run with coverage report
```
...
1. Fix failing tests (run `/prompts:pytest-runner tests/test_user.py` to retest)
