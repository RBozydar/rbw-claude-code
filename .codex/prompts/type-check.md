...
<!-- Generated from plugins/python-backend/commands/type-check.md -->
...
```bash
/prompts:type-check                    # Check all files
/prompts:type-check src/               # Check specific directory
/prompts:type-check src/services/      # Check module
/prompts:type-check --strict           # Run with strict mode
/prompts:type-check affected           # Check only changed files
```
