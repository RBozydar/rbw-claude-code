...
<!-- Generated from plugins/core/commands/triage.md -->
...
2. Start work on approved items:
   ...
   ```bash
   /prompts:resolve_todo_parallel  # Work on multiple approved items efficiently
   ```
...
- ❌ That's for /prompts:resolve_todo_parallel phase
```
...
1. run /prompts:resolve_todo_parallel to resolve the todos
2. commit the todos
3. nothing, go chill
```
